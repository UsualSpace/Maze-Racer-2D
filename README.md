...
This project's implementation of the Maze Racer Multiplayer Protocol (MRMP) uses windows api for sockets, multi-threading, and concurrency so it will only work on windows, but can pretty easily be adapted to other systems.
